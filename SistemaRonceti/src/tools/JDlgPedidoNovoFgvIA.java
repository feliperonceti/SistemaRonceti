 ...
 */
public class JDlgPedidoNovoFgvIA extends javax.swing.JDialog {

    /**
     * Creates new form JDlgPedidoNovoIA
     */
    public JDlgPedidoNovoFgvIA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Modelo Telefone");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgPedidoNovoFgvIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgPedidoNovoFgvIA dialog = new JDlgPedidoNovoFgvIA(new javax.swing.JFrame(), true);
