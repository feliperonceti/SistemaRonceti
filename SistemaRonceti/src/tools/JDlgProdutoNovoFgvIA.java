 ...
 */
public class JDlgProdutoNovoFgvIA extends javax.swing.JDialog {

    /**
     * Creates new form JDlgProdutoNovoFgvIA
     */
    public JDlgProdutoNovoFgvIA(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Inclusão");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgProdutoNovoFgvIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgProdutoNovoFgvIA dialog = new JDlgProdutoNovoFgvIA(new javax.swing.JFrame(), true);
